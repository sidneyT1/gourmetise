import { reactive as F, toRaw as T, createApp as pe, nextTick as se, isVNode as de, mergeProps as P, defineComponent as W, ref as q, computed as f, watchEffect as z, createVNode as l, cloneVNode as Ae, onMounted as ue, onUnmounted as ce, h as k, Fragment as Ne } from "vue";
const H = {
  TOP_LEFT: "top-left",
  TOP_RIGHT: "top-right",
...
function we(e) {
  var E;
  const { position: t, containerClassName: n, rtl: a = !1, style: o = {} } = e, s = r.CSS_NAMESPACE, d = qe(t), v = document.querySelector(`.${s}`), u = document.querySelector(`.${d}`), A = !!u && !((E = u.className) != null && E.includes(K)), m = v || document.createElement("div"), S = document.createElement("div");
  S.className = Be(
    t,
    n,
    a
  ...
  remove(e) {
    if (e) {
      ...
      if (t) {
        ...
        c[t] = n.filter((o) => o.toastId !== e), !c[t].length && !De(t) && te(t, !1), xe(), se(() => {
...
function nt({
  ...
  return n ? o = oe.spinner() : a === !1 ? o = void 0 : G(a) ? o = T(a) : B(a) ? o = a(s) : de(a) ? o = Ae(a, s) : ae(a) || ze(a) ? o = a : tt(t) && (o = oe[t](s)), o;
}
const at = () => {
};
...
function st(e) {
  ...
  }), d = s.done || at, v = f(() => s.appendPosition ? `${s.enter}--${s.position}` : s.enter), u = f(() => s.appendPosition ? `${s.exit}--${s.position}` : s.exit), A = f(() => e.pauseOnHover ? {
    onMouseenter: h,
    onMouseleave: I
  } : {});
  function m() {
...
const rt = /* @__PURE__ */ W({
  ...
  setup(e) {
    ...
    }, null), G(e.closeButton) ? k(T(e.closeButton), {
      closeToast: u,
      type: e.type,
      theme: e.theme
